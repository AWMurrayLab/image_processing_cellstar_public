...
#-------------------------------------------
y1,z1='D','pWHI5-WHI5'
temp_xv,temp_yv,save_ext='$V_{b,ell}$','$\Delta V_{G1,ell}$','dvG1_vb'
temp_xlab, temp_ylab = 'Volume at birth (fL)', '$\Delta V$ in G1 (fL)'
bin_range=(20,55)
y,z,save_path=df.type==y1,df.genotype==z1,bp+y1+'_'+z1[:5]+'_'+save_ext+'.png'
fig=c.plotting_heatmap(temp_xv,temp_yv,df[y&z],bin_range,xlab=temp_xlab,ylab=temp_ylab,temp_title=titles[z1],temp_cmap='Oranges')
fig.savefig(save_path,bbox_inches='tight',dpi=500)
...
#-------------------------------------------
y1,z1='D','pWHI5-WHI5'
temp_xv,temp_yv,save_ext='$V_{s,ell}$','$\Delta V_{budded,ell}$','dvbud_vs'
temp_xlab, temp_ylab = 'Volume at Start (fL)', '$\Delta V$ during budding (fL)'
bin_range=(35,95)
y,z,save_path=df.type==y1,df.genotype==z1,bp+y1+'_'+z1[:5]+'_'+save_ext+'.png'
fig=c.plotting_heatmap(temp_xv,temp_yv,df[y&z],bin_range,xlab=temp_xlab,ylab=temp_ylab,temp_title=titles[z1],temp_cmap='Oranges')
fig.savefig(save_path,bbox_inches='tight',dpi=500)
...
#-------------------------------------------
y1,z1='D','pWHI5-WHI5'
temp_xv,temp_yv,save_ext='$V_{b,ell}$','$\Delta V_{full,ell}$','dvfull_vb'
temp_xlab, temp_ylab = 'Volume at birth (fL)', '$\Delta V$ birth to division (fL)'
bin_range=(20,55)
y,z,save_path=df.type==y1,df.genotype==z1,bp+y1+'_'+z1[:5]+'_'+save_ext+'.png'
fig=c.plotting_heatmap(temp_xv,temp_yv,df[y&z],bin_range,xlab=temp_xlab,ylab=temp_ylab,temp_title=titles[z1],temp_cmap='Oranges')
fig.savefig(save_path,bbox_inches='tight',dpi=500)
...
bin_range=(20,55)
y,z,save_path=df.type==y1,df.genotype==z1,bp+y1+'_'+z1[:5]+'_'+save_ext+'.png'
fig=c.plotting_heatmap(temp_xv,temp_yv,df[y&z],bin_range,xlab=temp_xlab,ylab=temp_ylab,temp_title=titles[z1],temp_cmap='Blues', temp_xlim=xlim, temp_ylim=ylim,gridsize=[20,6])
fig.savefig(save_path,bbox_inches='tight',dpi=500)
plt.clf()
#-------------------------------------------
y1,z1='D','pWHI5-WHI5'
...
#-------------------------------------------
y1,z1='D','pWHI5-WHI5'
temp_xv,temp_yv,save_ext='$V_{b,ell}$','$V_{div,ell}$','vb_vd'
...
#-------------------------------------------
y1,z1='D','pGAL1-WHI5'
temp_xv,temp_yv,save_ext='$c1_{b,seg,norm}$', '$t_{G1}$','tg1_c1b'
temp_xlab, temp_ylab = '[Whi5] at birth (a.u.)', 'Time in G1 (min)'
bin_range=(0.5,1.6)
y,z,save_path=df.type==y1,df.genotype==z1,bp+y1+'_'+z1[:5]+'_'+save_ext+'.png'
fig=c.plotting_heatmap(temp_xv,temp_yv,df[y&z],bin_range,xlab=temp_xlab,ylab=temp_ylab,temp_title=titles[z1],temp_cmap='Blues',temp_xlim=[0.4,2.2],temp_ylim=[0.0,250.0],gridsize=[30,10])
fig.savefig(save_path,bbox_inches='tight',dpi=500)
xlim = plt.xlim()  # we want each comparison plot to look the same so we get the axes from the first and give it to the second
ylim = plt.ylim()
plt.clf()
...
bin_range=(0.75,1.55)
y,z,save_path=df.type==y1,df.genotype==z1,bp+y1+'_'+z1[:5]+'_'+save_ext+'.png'
fig=c.plotting_heatmap(temp_xv,temp_yv,df[y&z],bin_range,xlab=temp_xlab,ylab=temp_ylab,temp_title=titles[z1], temp_xlim=xlim, temp_ylim=ylim,temp_cmap='Oranges',gridsize=[25,15])
fig.savefig(save_path,bbox_inches='tight',dpi=500)
plt.clf()
#-------------------------------------------
y1,z1='D','pWHI5-WHI5'
temp_xv,temp_yv,save_ext='$c2_{b,seg,norm}$','$t_{G1}$','tg1_c2b'
temp_xlab, temp_ylab = '[mCherry] at birth (a.u.)', 'Time in G1 (min)'
bin_range=(0.8,1.3)
y,z,save_path=df.type==y1,df.genotype==z1,bp+y1+'_'+z1[:5]+'_'+save_ext+'.png'
fig=c.plotting_heatmap(temp_xv,temp_yv,df[y&z],bin_range,xlab=temp_xlab,ylab=temp_ylab,temp_title=titles[z1],temp_cmap='Oranges')
fig.savefig(save_path,bbox_inches='tight',dpi=500)
...
bin_range=(0.8,1.3)
y,z,save_path=df.type==y1,df.genotype==z1,bp+y1+'_'+z1[:5]+'_'+save_ext+'.png'
fig=c.plotting_heatmap(temp_xv,temp_yv,df[y&z],bin_range,xlab=temp_xlab,ylab=temp_ylab,temp_title=titles[z1],temp_cmap='Blues', temp_xlim=xlim, temp_ylim=ylim,gridsize=[10,10])
fig.savefig(save_path,bbox_inches='tight',dpi=500)
plt.clf()